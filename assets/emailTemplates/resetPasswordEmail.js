            ...
            const info = await transporter.sendMail({
                ...
                html: `<html>
                            <body style="color:#083a08; font-family: Lato, Arial, Helvetica, sans-serif;
                                ...
                                <p style="text-decoration: underline; font-size: 24px;"><a style="color:#4054b2;font-weight: 600;" href="https://ultrenostimesheets.take2tech.ca/?reset=${emailEncode}"> Reset Password</a></p>
